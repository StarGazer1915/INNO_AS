...
class Maze:
    ...
    def step(self, state_coordinate, chosen_action):
        ...
        """
        current_state = self.environment[state_coordinate[0]][state_coordinate[1]]
        ...
        try:
            ...
            if new_state_coordinate[0] < 0 or new_state_coordinate[1] < 0:
                return current_state, current_state, current_state.terminal, current_state.reward
            else:
                new_state = self.environment[new_state_coordinate[0]][new_state_coordinate[1]]
                return current_state, new_state, new_state.terminal, new_state.reward
        except IndexError:
            return current_state, current_state, current_state.terminal, current_state.reward
